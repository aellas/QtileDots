...
This repository contains my configuration files for the [Qtile](https://qtile.org/) window manager. I use [Symlinks](https://en.wikipedia.org/wiki/Symbolic_link) to help manage it. 
